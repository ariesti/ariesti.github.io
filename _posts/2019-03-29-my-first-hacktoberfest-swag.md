...
<div class="mt-2"><b><span class="grey">Make sure the viewport is for responsive pages.</span></b></div> Modern websites are built with mobile in mind, so they've got to be responsive and stay responsive. You should be able to go over the website code and check if the viewport meta tag is correctly set up.
